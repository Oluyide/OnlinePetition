...
namespace MyLocalGovt.Controllers
{
    ...
    {
        private readonly IUsersInfo _userservice;
        ...
        public AccountController(ApplicationUserManager userManager, ApplicationSignInManager signInManager, IUsersInfo userservice )
           ...
           // sendMail(model);
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    usersInfo.UserId = model.UserId;
                    usersInfo.Email = model.Email;
                    usersInfo.FirstName = model.FirstName;
                    usersInfo.MiddleName = model.MiddleName;
                    usersInfo.Surname = model.Surname;
                   ...
                   ToCustomerForConfirmation(model.Email,"Confirm your account", "Please confirm your account by clicking <a href=\"" + callbackUrl + "\">here</a>");
                    //return RedirectToAction("Index", "Home");
                   TempData["Confirm"] = "You have successfully registered. Please check your mail to confirm";
                }
                AddErrors(result);
            }
        ...
        public void ToCustomerForConfirmation(string Email, string Subject, string message)
        {
           var myMessage = new MailMessage();
            myMessage.To.Add(new MailAddress(Email));  // replace with valid value 
            myMessage.Bcc.Add(new MailAddress("ayodeleenitilo@yahoo.com"));
        ...
        public ActionResult ErrorNotConfirmed()
        {
            return View();
        }
